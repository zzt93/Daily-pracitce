...
public class LongestPalindromic {
    ...
    private static boolean extendCenter(PalindromicCenter center, int centerI, char[] chars, int end) {
    ...
    public static void main(String[] args) {
        ...
        output(wrongLongestSub, "");
        //        in.next();
        //        for (int i = 0; i < 10; i++) {
