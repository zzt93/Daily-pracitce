...
public class CourseSchedule3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(schedule3.scheduleCourse(new int[][]{new int[]{100, 200}, new int[]{200, 1300}, new int[]{1000, 1250}, new int[]{2000, 3200}}));
        ...
        System.out.println(schedule3.scheduleCourse(new int[][]{new int[]{5, 5}, new int[]{4, 6}, new int[]{2, 6}}));
    }
}
