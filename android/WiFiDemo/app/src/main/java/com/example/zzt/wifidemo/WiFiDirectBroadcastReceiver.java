package com.example.zzt.wifidemo;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (manager != null) {
                ...
                PeerListListener fragmentById = (PeerListListener) activity.getFragmentManager()
                        .findFragmentById(R.id.frag_list);
                fragmentById.onPeersAvailable(list);
//                manager.requestPeers(channel, fragmentById);
            }
